...
class pyparsing_test:
    ...
    class reset_pyparsing_context:
        ...
        def save(self):
            ...
            self._save_context["packrat_enabled"] = ParserElement.packratEnabled
            if ParserElement.packratEnabled:
                self._save_context[
                    "packrat_cache_size"
                ] = ParserElement.packrat_cache.size
            else:
                self._save_context["packrat_cache_size"] = None
            self._save_context["packrat_parse"] = ParserElement.parse
            self._save_context[
                "recursion_enabled"
            ] = ParserElement.left_recursion_enabled

            self._save_context["__diag__"] = {
                name: getattr(__diag__, name) for name in __diag__.all_names
            }
